...
const en = {
  ...
  goals: {
    ...
    detail: {
      ...
      summary: 'Summary',
      currentValue: 'Current Value',
      finishedWithValue: 'Finished with Value',
      finishedValueDisclaimer: 'Value based on the price at the date of completion.',
      holdingValueLabel: 'Value',
      soldValueWithDate: 'Sold value \u2022 {{date}}',
