export default {
  ...
  addHolding: {
    ...
    details: {
      title: 'Detail Emas',
      subtitle: 'Masukkan detail fisik dan riwayat pembelian.',
      weight: 'Berat (gram)',
      purchaseHistory: 'Riwayat Pembelian (Opsional)',
      purchasePrice: 'Harga Beli (Total IDR)',
      priceHelp: 'Harga yang Anda bayar saat membeli emas ini.',
