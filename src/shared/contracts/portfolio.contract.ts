...
export const BrandAllocationSchema = z.object({
  ...
  valuationSource: z.enum(['BUYBACK', 'USER', 'NONE', 'MIXED']),
...
export const PortfolioSummarySchema = z.object({
  ...
  totalDailyPnL: z.number().int().nullable(),
  totalDailyPnLPercentage: z.number().nullable(),
  totalWeeklyPnL: z.number().int().nullable(),
  totalWeeklyPnLPercentage: z.number().nullable(),
  totalMonthlyPnL: z.number().int().nullable(),
  totalMonthlyPnLPercentage: z.number().nullable(),
  totalYearlyPnL: z.number().int().nullable(),
  totalYearlyPnLPercentage: z.number().nullable(),
